...
class DataPreprocessing:
    ...
    def extract_room_number(self, df):
    ...
    def create_rolling_windows(self, df, rolling_window = "1h", sample_time = "10min"):
        """Create rolling windows for a given DataFrame to calculate averages over defined timespans."""
