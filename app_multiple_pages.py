...
# Load data
df = pd.read_parquet("../Gebäude_M_Analysis/Preprocessed_M_Data.parquet")   # dataframe with no rolling window and no sampling greater than 1 hour
df_forecast = pd.read_parquet("df_forecast.parquet")    # dataframewith rolling window 3d and sample time 1d
